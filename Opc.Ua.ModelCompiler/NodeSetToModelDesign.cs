...
;                        m_aliases[ii.Alias] = ImportNodeId(ii.Value, false);
        ...
        public ModelDesign Import()
        {
            ...
            Dictionary<NodeId, List<Opc.Ua.ReferenceNode>> references = new Dictionary<NodeId, List<Opc.Ua.ReferenceNode>>();
    ...
    {
      ValueRank output = default (ValueRank);
      if (input > 1)
        output = ValueRank.OneOrMoreDimensions;
      else if (input == 1)
        output = ValueRank.Array;
      else if (input == 0)
        output = ValueRank.OneOrMoreDimensions;
      else if (input == -1)
        output = ValueRank.Scalar;
      else if (input <= -2)
        output = ValueRank.ScalarOrArray;
      return output;
    }
    //private ValueRank ImportValueRank(int input) =>
    //        input switch
    ...
    //        };
        ...
        private NodeDesign Import(ISystemContext context, NodeSet.UANode node)
        {
            ...
            switch (nodeClass)
            {
                case NodeClass.Object:
                {
                    ...
                    ObjectDesign value = new ObjectDesign();
                ...
                case NodeClass.Variable:
                {
                    ...
                    VariableDesign value = new VariableDesign();
                ...
                case NodeClass.Method:
                {
                    ...
                    MethodDesign value = new MethodDesign();
                ...
                case NodeClass.View:
                {
                    ...
                    ViewDesign value = new ViewDesign();
                ...
                case NodeClass.ObjectType:
                {
                    ...
                    ObjectTypeDesign value = new ObjectTypeDesign();
                ...
                case NodeClass.VariableType:
                {
                    ...
                    VariableTypeDesign value = new VariableTypeDesign();
                ...
                case NodeClass.DataType:
                {
                    ...
                    DataTypeDesign value = new DataTypeDesign();
                    value.IsAbstract = o.IsAbstract;
                ...
                case NodeClass.ReferenceType:
                {
                    ...
                    ReferenceTypeDesign value = new ReferenceTypeDesign();
                    value.IsAbstract = o.IsAbstract;
        ...
        private Opc.Ua.DataTypeDefinition Import(NodeSet.UADataType dataType, NodeSet.DataTypeDefinition source, NamespaceTable namespaceUris)
        {
            ...
            if (source.Field != null)
            {
                ...
                if (isStructure)
                {
                    DataTypeDesign sd = new DataTypeDesign();
                ...
                {
                    DataTypeDesign ed = new DataTypeDesign();
